...
Com isso, é possível ver que na maior parte das vezes, utilizar ângulos próprios para cada bit-string se sobressai ao valor padrão. No entanto, ao utilizar esses valores com outras bit-strings, os resultados não conseguem alcançar tal limiar.


% add images here


Além disso, para bit-strings de dois bits, oo valor convencional se saí invicto.
...
Com isso, para ter o melhor dos dois mundos, foi usado uma versão hibrida do algoritmo. Assim, ao criar o circuito, passado o valor a ser encodado por uma Look-up-table e pegando o melhor angulo para encontrar o valor desejado. Dessa forma, é possível maximizar as probabilidades.
